            ...
            <CardContent>
              ...
              >
                ...
                {uploadedFileName
                  ...
                  : <><p className="text-sm font-medium mb-1">Drop documents here</p><p className="text-xs text-muted mb-3">PDF, DOCX, TXT, CSV, Markdown</p></>
                }
                {!uploadedFileName && <Button variant="outline" size="sm" onClick={e => { e.stopPropagation(); fileInputRef.current?.click() }}>Browse Files</Button>}
              </div>
              {uploadStep > 0 && (
                <div className="space-y-2">
