...
export default function BuilderPage() {
  ...
  return (
    <div className="container-page py-8 max-w-7xl">
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Link href="/lab" className="text-xs text-muted hover:text-foreground">Home</Link>
            <ChevronRight className="w-3 h-3 text-muted" />
            <span className="text-xs font-medium">Build Your Own Assistant</span>
          </div>
      ...
      <div className="mt-6 flex items-start gap-3 p-4 rounded-xl bg-blue-50 border border-blue-200 text-sm text-blue-700">
        ...
        <div>
          <strong>100% Free Stack:</strong> Groq free tier (14,400 req/day) + PDF.js (browser) + TF-IDF search (client-side) + this page hosted on Cloudflare Pages. No backend, no database, no monthly cost.
        </div>
      </div>
    </div>
  )
